				...
				<?php
					...
					echo '<div class="comprarAhora" style="display:none">
						...
						if($infoproducto["oferta"] == 0){
							...
							<p class="subTotal'.$infoproducto["id"].' subtotales">
								...
								<strong>MX $<span>'.$infoproducto["precio"].'</span></strong>
							...
							<p class="subTotal'.$infoproducto["id"].' subtotales">
								...
								<strong>MX $<span>'.$infoproducto["precioOferta"].'</span></strong>
					...
					if($infoproducto["precio"] == 0){
						...
						if($infoproducto["oferta"] == 0){
							...
							echo '<h2 class="text-muted">MX $'.$infoproducto["precio"].'</h2>';
					...
					echo '<li class="col-md-3 col-sm-6 col-xs-12">
						...
						if($value["precio"] == 0){
							...
							if($value["oferta"] != 0){
								...
								echo '<h2><small>MX $'.$value["precio"].'</small></h2>';
					...
					<div class="col-sm-6 col-xs-12 pull-right">
						...
						<table class="table table-striped tablaTasas">
							...
							<tbody>
								...
								<tr>
									<td>Subtotal</td>	
									<td><span class="cambioDivisa">MX</span> $<span class="valorSubtotal" valor="0">0</span></td>	
								</tr>

								<tr>
									<td>Envío</td>	
									<td><span class="cambioDivisa">MX</span> $<span class="valorTotalEnvio" valor="0">0</span></td>	
								</tr>

								<tr>
									<td>Impuesto</td>	
									<td><span class="cambioDivisa">MX</span> $<span class="valorTotalImpuesto" valor="0">0</span></td>	
								</tr>

								<tr>
									<td><strong>Total</strong></td>	
									<td><strong><span class="cambioDivisa">MX</span> $<span class="valorTotalCompra" valor="0">0</span></strong></td>	
								</tr>
