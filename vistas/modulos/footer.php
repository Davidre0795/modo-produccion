...
<footer class="container-fluid">
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			$datos_contacto = ControladorPlantilla::ctrEstiloPlantilla();
			...
			<div class="col-md-3 col-sm-6 col-xs-12 text-left infoContacto">
				...
				<h5>
					...
					<i class="fa fa-phone-square" aria-hidden="true"></i> '.$datos_contacto["phone_number"].'

					<br><br>

					<i class="fa fa-envelope" aria-hidden="true"></i> '.$datos_contacto["email"].'

					<br><br>

					<i class="fa fa-map-marker" aria-hidden="true"></i> '.$datos_contacto["address"].'

					<br><br>
					'.$datos_contacto["city"].' | '.$datos_contacto["country"].'
			...
			<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 formContacto">
				...
				<iframe src="'.$datos_contacto["map"].'" width="100%" height="200" frameborder="0" style="border:0" allowfullscreen></iframe>	
