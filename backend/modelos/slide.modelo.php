...
class ModeloSlide{	
	...
	static public function mdlCrearSlide($tabla, $datos, $orden){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre,imgFondo, tipoSlide,imgProducto,estiloImgProducto, estiloTextoSlide, titulo1, titulo2, titulo3, boton, url, orden) VALUES (:nombre, :imgFondo, :tipoSlide,:imgProducto, :estiloImgProducto,:estiloTextoSlide, :titulo1, :titulo2, :titulo3, :boton, :url, :orden)");
		...
		$stmt->bindParam(":imgProducto", $datos["imgProducto"], PDO::PARAM_STR);
